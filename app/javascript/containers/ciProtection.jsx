...
import header from '../../../public/images/header-icon-02.png'
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-12'>
              <div>
                <div className='sr-cancer__container'>
                  <div>
                    <div className="row">
                      <div className="col-12">
                        <div className="row">
                          <div className="col-12 sr-cancer__div__title">
                            <text className="sr-cancer__title">CI Protection</text>
                          </div>
                          <div className="col-12 sr-cancer__div__image">
                            <img className="sr-cancer__image" src={header} />
                          </div>
                          <div className="col-12 sr-cancer__div__subtitle">
                            <text className="sr-cancer__subtitle">Some things are worth wverything. protect them.</text>
                          </div>
                          <div className="col-12 sr-cancer__div__verticalLine">
                            <div className="sr-cancer__verticalLine" />
                          </div>
                          <div className="col-12 sr-cancer__div__title_blue">
                            <text className="sr-cancer__title_blue">Reasons that you should purchase this instance</text>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="col-12">
                        <div >
                          ...
                          <Reason image={icon04} title="Term CI Protection" content="Ensure your loved one's financial future is protected, in the event you become terminally ill or unexpectedly pass away." />
                        </div>
                      </div>
                      <div className="col-12">
                        <div className="row">
                          <div className="col-12">
                            ...
                            <Link className="button-224 btn btn-green btn-lg btn-green--large-text" to={this.state.currentUser.id ? `/step/CANCER` : `/login/CANCER`}>Get a quote</Link>
                          </div>
                        </div>
                      </div>
